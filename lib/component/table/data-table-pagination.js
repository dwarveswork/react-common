...
export const DataTablePagination = props => {
    ...
    return (React.createElement("div", { className: clsx(classes.root, className) },
        ...
        React.createElement(IconButton, { onClick: onNextClick, disabled: pageIndex === pageCount },
            React.createElement(ChevronRight, null)),
        React.createElement(IconButton, { onClick: onLastClick, disabled: pageIndex === pageCount },
