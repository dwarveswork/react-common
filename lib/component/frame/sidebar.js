...
export const Sidebar = props => {
    ...
    return (React.createElement("div", { className: clsx(classes.root, className) },
        ...
        React.createElement(List, null, routes.filter(route => route.menu).map((route) => (React.createElement(ListItem, { key: route.key, className: classes.menuItem, button: true, component: 'a', disableGutters: true, selected: router.selection.key === route.key, onClick: () => router.navigate(route) },
